...
# model settings
atten_cfg = {'graph_type': 'i3n303', 'unary_op': [[16], [0, 13], [0, 25], [6], [0], [25, 0]], 'binary_op': [6, 3, 2]}
model = dict(
    type='EncoderDecoder',
    # pretrained='../Detection/pretrained/AutoAtten_pvt_tiny_max_acc.pth',
    ...
    backbone=dict(
        ...
        scale=-0.5,
        atten_cfg=atten_cfg,
        init_cfg=dict(type='Pretrained', checkpoint='pretrained/AutoAtten_pvt_tiny_max_acc.pth')
    ),
