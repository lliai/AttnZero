...
class AutoAttention_Bias(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.,
                 shift_size=0, atten_cfg=None, **kwargs):
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
        ...
        if attn_type == 'A':
            self.attn = AutoAttention_Bias(dim=dim, window_size=to_2tuple(self.window_size), num_heads=num_heads,
...
class AutoAttenSwinTransformer_Bias(nn.Module):
    r""" Swin Transformer
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 attn_type='BBBB', atten_cfg = None, **kwargs):
        super().__init__()
