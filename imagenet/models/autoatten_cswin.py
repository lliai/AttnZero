...
def AutoAtten_CSWin_64_24181_tiny_224(pretrained=False, **kwargs):
...
def AutoAtten_CSWin_64_36292_small_224(pretrained=False, **kwargs):
...
def AutoAtten_CSWin_96_36292_base_224(pretrained=False, **kwargs):
...
def AutoAtten_CSWin_96_36292_base_384(pretrained=False, **kwargs):
    model = CSWinTransformer(patch_size=4, embed_dim=96, depth=[3, 6, 29, 2],
