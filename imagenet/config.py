...
# -----------------------------------------------------------------------------
# AutoAttention options
# -----------------------------------------------------------------------------

# re-named from agent setting

_C.MODEL.STAGE_ATTN_TYPE = 'BBBB'
_C.MODEL.PVT_LA_SR_RATIOS = 1111
_C.MODEL.CSWIN_LA_SPLIT_SIZE = '56-28-14-7'


# auto attention

_C.MODEL.AT = CN()
_C.MODEL.AT.GRAPH_TYPE = 'i3n401'
_C.MODEL.AT.UNARY_OP = [[16],[0],[16],[16,17],[16],[0],[8, 18],[0]]
_C.MODEL.AT.BINARY_OP = [5,7,3,2]


_C.MODEL.AUTOFORMER = CN()
_C.MODEL.AUTOFORMER.HIDDEN_DIM = None
_C.MODEL.AUTOFORMER.MLP_RATIO = None
_C.MODEL.AUTOFORMER.DEPTH = None
_C.MODEL.AUTOFORMER.NUM_HEADS = None
