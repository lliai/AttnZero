...
from autoatten.operators import (available_zc_candidates, binary_operation,
                           get_zc_candidates, sample_binary_key_by_prob,
                           sample_unary_key_by_prob, unary_operation)
import torch.nn as nn
from autoatten.operators.binary_ops import BINARY_KEYS
from autoatten.operators.unary_ops import UNARY_KEYS
from . import measure
from autoatten.structures.utils import convert_to_float
...
def compute_score1(
    ...
    def compute_t3g(net, inputs, targets, loss_fn):
        t3g_list = []
...
def compute_score2(
    ...
    def compute_t1g(net, inputs, targets, loss_fn):
