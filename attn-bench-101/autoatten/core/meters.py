...
def topk_accs(preds, labels, ks):
    ...
    return _topk_accs(preds, labels, ks)


def _topk_accs(preds, labels, ks):
...
class TrainMeter(object):
    ...
    def update_stats(self, top1_acc, top5_acc, cls_loss, inter_loss, logit_loss, loss, lr, mb_size):
